...
import { useLoading, useOutput } from '../app/(store)/useStore';
...
function PreviewImg() {
    ...
    return isLoading ? (
      <div
        ...
        <Image width={100} height={100} src="./couch.svg" alt="couch" />
      </div>
    ) : (
      <div className="my-auto">
        <Image src={output} width={500} height={300} alt="output" className='rounded-lg object-cover'/>
      </div>
    );
}
